...
import jsonPrefecture from "../json/prefectures_org.json";
import jsonIndust from "../json/industries_org.json";
import jsonJobs from "../json/job_type_org.json";
import jsonLanguages from "../json/languages_org.json";
import jsonCountries from "../json/country_en_org.json";
import jsonCharector from "../json/rec_characteristics_org.json";
import jsonVisa from "../json/visa_org.json";
...
async function main() {
  ...
  const createPrefecture = async () => {
    ...
    await asyncForEach(jsonPrefecture, async (element) => {
      await waitFor(50);
      i++;
      ...
      const dictMaxId =
        dictfromMaxId._max.dictionary_id === null
          ? 1
  ...
  const createIndustries = async () => {
    ...
    await asyncForEach(jsonIndust, async (element) => {
      await waitFor(50);
      i++;
      ...
      await asyncForEach(element.subcategory, async (sub) => {
        ...
        const dictMaxId1 =
          dictfromMaxId1._max.dictionary_id === null
            ? 1
  ...
  const createJob = async () => {
    ...
    await asyncForEach(jsonJobs, async (element) => {
      await waitFor(50);
      i++;
  ...
  const createLanuages = async () => {
    ...
    await asyncForEach(jsonLanguages, async (element) => {
      await waitFor(50);
      i++;
  ...
  const createJob_Charac = async () => {
    ...
    await asyncForEach(jsonCharector, async (element) => {
      await waitFor(50);
      i++;
  ...
  const createCountries = async () => {
    ...
    if (checkdata === null) {
      ...
      await asyncForEach(jsonCountries, async (element) => {
        await waitFor(50);
        i++;
  ...
  const createVisaTypes = async () => {
    ...
    await asyncForEach(jsonVisa, async (element) => {
      await waitFor(50);
      i++;
